<?php require('../controlleur/contr_update_article.php'); ?>
...
<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-5">
				...
				<div class="row">
					<div class="col-md-6"><h3>Modifier un article</h3></div>
					<div class="col-md-6">
	...
	<div class="row">
				...
				<div class="row">
					<div class="col-md-12">
						<center><button style="width: 110px;" type="submit" name="submit" class="form-control btn-primary mt-3">Mettre à jour</button ></center> 
					</div>
				</div>
